import { FAQInterface } from "@/libs/interfaces/faq";

export const FAQS: FAQInterface[] = [
  {
    question: "How much does a brand identity cost?",
    answer:
      "Our baseline engagements start at $5,000 for standard identity packages. However, every project is uniquely scoped based on your specific requirements, the complexity of the deliverables, and the scale of your business.",
  },
  {
