...
import { servicesMarqueeData } from "@/libs/constants/servicesMarqueeData";

export function ServicesMarquee() {
  return (
    <div className="relative w-full overflow-hidden bg-foreground text-background py-6 sm:py-8 border-y z-2 border-border skew-y-3">
      {/* 
